...
<head profile="http://gmpg.org/xfn/11">
 ...
 <?php wp_head();?>
  <script>
    ...
    ga('create', 'UA-67048586-1', 'auto');
    ga('send', 'pageview');

  </script>
</head>
<body <?php body_class(); ?> style="background-image: url('<?= get_stylesheet_directory_uri(); ?>/img/bg-<?= rand(1,3)?>.png')">
  <header>
    <div>
      <div id="large-affix">
        <div class='navbar '>
          <div class="navbar-header">
            ...
            <div class="profile-container pull-right">
              <?php
                global $current_user;
                get_currentuserinfo();
  ...
  <img src="<?= get_stylesheet_directory_uri(); ?>/img/bg-<?= rand(1,3)?>.png" class="image-highlight" />